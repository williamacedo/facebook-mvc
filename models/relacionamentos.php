<?php 
    class Relacionamentos extends model {
        ...
        public function getRequisicoes() {
            $array = array();
            $sql = "SELECT usuarios.id, usuarios.nome FROM relacionamentos LEFT JOIN usuarios ON usuarios.id = relacionamentos.usuario_de WHERE relacionamentos.usuario_para = '".$_SESSION['lgsocial']."' AND relacionamentos.status = '0'";
