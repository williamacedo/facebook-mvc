<?php 
    ...
    public function getSugestoes($limit = 5, $ids) {
        $array = array();
        ...
        $sql = "SELECT usuarios.id, usuarios.nome FROM usuarios WHERE usuarios.id != '$meuid' AND usuarios.id NOT IN (".implode(',', $ids).") ORDER BY RAND() LIMIT $limit";
